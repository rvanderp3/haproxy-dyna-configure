...
LDFLAGS="${LDFLAGS} -X github.com/openshift-splat-team/haproxy-dyna-configure/pkg/version.Raw=${GIT_TAG} -X github.com/openshift-splat-team/haproxy-dyna-configure/pkg/version.Commit=${GIT_COMMIT}"
TAGS="${TAGS:-}"
